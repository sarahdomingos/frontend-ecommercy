    ...
    <div class="checkout-container">
        ...
        <div id="pixDetails" class="pix-info">
            ...
            <div style="display: flex; ">
                <p><strong>Código de Pagamento:</strong> <input type="text" id="copyText"
                        value="ferFvdrErfefdVdfv_r23sde.fe_wfdfsfWE4EF23gbbc_" readonly
                        style="padding: 8px 40px 8px 12px; border: 1px solid #ccc; border-radius: 5px; width: 250px;">
                </p>
             ...
             color: #065f46;
         ">
                    <img src="{{ asset('img/copy.svg') }}"
                        style="width: 10%; display:flex; align-items:center; flex-direction:row; justify-content:center; align-content:center">
                </button>
            </div>
            ...
            <div class="alert">
                O pedido só será liberado mediante o pagamento, que deve ser feito em até <strong>30 minutos</strong>,
                ou será automaticamente cancelado.
            </div>
            <p style="margin-top: 20px; font-size: 13px; color: #666;">
                ⚠️ Este sistema é fictício, desenvolvido apenas para fins acadêmicos. Nenhum pagamento real será
                processado.
            </p>
